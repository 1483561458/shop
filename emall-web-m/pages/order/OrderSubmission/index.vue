<template>
  <view class="order-submission">
    ...
    <CouponListWindow v-on:couponchange="changecoupon($event)" v-model="showCoupon" 
	:price="orderPrice.totalPrice" :checked="usableCoupon.id" @checked="changeCoupon" :cartid="cartid" :storeId="storeId"></CouponListWindow>
...
<script>
  ...
  export default {
    ...
    onShow: function () {
	  ...
	  that.storeId = that.$yroute.query.storeId;
	  console.info("storeId==>"+that.storeId)
    },
    methods: {
      showStoreList() {
      ...
      createOrder() {
        ...
        createOrder(this.orderGroupInfo.orderKey, {
            ...
            from: this.from,
            mark: this.mark || "",
			shippingType: parseInt(0) + 1,//设置为供应商订单
